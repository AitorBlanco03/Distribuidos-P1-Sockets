...
public class ChatServerImpl implements ChatServer {
	...
	private final List<ChatClientListener> connectedUsers;
	...
	public void startup() {
		...
		try (ServerSocket serverSocket = new ServerSocket(serverPort)) {
			...
			while(isRunning) {
				...
				ChatClientListener newUser = new ChatClientListener(userSocket);
				addUser(newUser);
	...
	public void shutdown() {
		...
		try {
			...
			for (ChatClientListener user : connectedUsers) {
	 ...
	 */
	public void addUser(ChatClientListener newUser) {
	 ...
	 */
	public void removeUser(ChatClientListener user) {
	...
	public class ChatClientListener implements Runnable {
		 ...
		 */
		public ChatClientListener(Socket userSocket) {
		...
		private boolean isUserConnected(String user) {
			...
			try {
				...
				for (ChatClientListener userSession : connectedUsers) {
	...
	/**
	 * Método principal de la clase ChatServerImpl.
	 * <p>
